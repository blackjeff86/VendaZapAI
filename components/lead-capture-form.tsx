  ...
  return (
    <div>
      <form
        ...
        className="mt-8 grid gap-3 sm:max-w-6xl sm:grid-cols-2 lg:grid-cols-[1fr_1fr_1fr_1fr_1fr_auto]"
      >
        <input
          name="name"
          type="text"
        ...
        <input
          ...
          className="rounded-full border border-white/10 bg-black/20 px-5 py-3 text-sm text-white outline-none placeholder:text-white/35"
        />
        <div className="rounded-full border border-white/10 bg-black/20 px-5 py-3 text-sm text-white">
          <select
            name="niche"
            required
            defaultValue=""
        ...
        <input
          name="phone"
          type="text"
          placeholder="WhatsApp da loja (opcional)"
          className="rounded-full border border-white/10 bg-black/20 px-5 py-3 text-sm text-white outline-none placeholder:text-white/35"
        />
        <input
          name="website"
